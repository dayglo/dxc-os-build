...
rm -rf output-ubuntu-16.04-amd64-vmware-iso.old
mv output-ubuntu-16.04-amd64-vmware-iso output-ubuntu-16.04-amd64-vmware-iso.old || true

sleep 1

govc vm.destroy DXC-UBUNTU16.04-TEMPLATE || true

PACKER_LOG=1 packer build --only=vmware-iso --var-file ../../variables.json ../../dxc-ubuntu-16.04-amd64.json

govc vm.markastemplate DXC-UBUNTU16.04-TEMPLATE
